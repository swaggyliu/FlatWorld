...
def edu_2d_1_1():
    ...
    rigid2 = BallRigid(2, [0.3 + 0.2 * math.sqrt(2), 0.3 + 0.2 * math.sqrt(2)], 0.2, 1.0)
    bcs = [Gravity([0, -10.0])]
    ...
    analytical3 = GroundDomain(2, (0.5 + 0.2 * math.sqrt(2), 0.1), (-1, 0), bcs=[Fixed([0])])
    domains = [rigiddomain1, rigiddomain2, analytical1, analytical2, analytical3]
    ...
    while gui.running and t < 10.0:
        ...
        analytical2.draw(gui, 0x000000, leftlength=0, rightlength=0.4 + 0.2 * math.sqrt(2), linewidth=2)
